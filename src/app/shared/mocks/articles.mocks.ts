...
export const ARTICLESMOCK: Articles = {
  articles: [
    {
      ...
      tags: ['sit', 'reiciendis', 'consequuntur', 'nihil'],
    ...
    },
    {
      ...
      tags: ['occaecati', 'labore', 'consequatur', 'neque'],
      publishedDate: new Date(),
      favorited: false,
      favorites: 61,
      author: {
    ...
    },
    {
      ...
      tags: ['repellat', 'nostrum', 'excepturi', 'quaerat'],
      publishedDate: new Date(),
      favorited: false,
      favorites: 52,
      author: {
    ...
    },
    {
      ...
      tags: ['beatae', 'esse', 'exercitationem', 'hic'],
      publishedDate: new Date(),
      favorited: false,
      favorites: 18,
      author: {
    ...
    },
    {
      ...
      tags: ['tenetur', 'quasi', 'eos', 'possimus'],
      publishedDate: new Date(),
      favorited: false,
      favorites: 17,
      author: {
    ...
    },
    {
      ...
      tags: ['aut', 'deserunt', 'occaecati', 'vitae'],
      publishedDate: new Date(),
      favorited: false,
      favorites: 11,
      author: {
    ...
    },
    {
      ...
      tags: ['repellat', 'quasi', 'et', 'blanditiis'],
      publishedDate: new Date(),
      favorited: false,
      favorites: 11,
      author: {
    ...
    },
    {
      ...
      tags: ['aliquid', 'qui', 'consequatur', 'nihil'],
      publishedDate: new Date(),
      favorited: false,
      favorites: 12,
      author: {
